...
import { LayoutDashboard, Package, Tags, ShoppingCart, ArrowLeft, LogOut, Sparkles } from "lucide-react";
...
export default function AdminSidebar() {
  ...
  return (
    <div className="flex h-screen w-64 flex-col bg-stone-900 text-stone-300 border-r border-stone-800">
      {/* Sidebar Header */}
